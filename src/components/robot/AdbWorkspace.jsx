...
export default function AdbWorkspace({
  ...
  agentBaseUrl, agentToken, agentDetecting, agentVersion, agentManifest, agentLaunchState, hasAgentInstallHint, onStartAgent, onRememberAgentInstall, onDetect, handleConnect, handleDisconnect, refreshDevices, refreshingDevices, dangerCommand, setDangerCommand, onRecordOperation,
}) {
  ...
  const installerUrl = agentManifest?.installerUrl || 'https://github.com/ShiinaMayuri123/Online_Tools/releases/latest/download/adb-agent-setup.exe';
