...
const Admin = () => {
  ...
  return (
    <ToolLayout
      ...
      contentClassName="pt-20 sm:pt-24 pb-16 sm:pb-20 px-4 sm:px-6 lg:px-10 xl:px-16 w-full max-w-[90%] lg:max-w-[85%] xl:max-w-7xl mx-auto relative z-10 space-y-6"
    >
      {/* 提示信息 */}
